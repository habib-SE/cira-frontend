...
//   return (
//     <div className="flex flex-col items-center justify-between bg-[#fefcfd] h-screen px-6 pt-10 pb-6">
//       {/* Logo and Heading */}
...
//         <div className="mt-4">
//           <span className="inline-block bg-pink-600 text-white text-sm font-semibold px-4 py-1 rounded-full shadow-md">
//             Ask Cira
//           </span>
//         </div>
//       </div>
...
const CiraMobileBanner = ({ onAskCira }) => {
  ...
  const handleAskCira = async () => {
    const res = await talkToAgent("I need medical help");
    setAssistantReply(res.text || "No response");
  };
  ...
  return (
    <div className="flex flex-col items-center justify-between bg-[#fefcfd] h-screen px-6 pt-10 pb-6 overflow-y-auto">
      ...
      {/* Assistant Reply */}
      {assistantReply && (
        <div className="w-full mt-6 bg-gray-100 p-4 rounded text-gray-800 text-center text-sm">
          {assistantReply}
        </div>
      )}
    </div>
