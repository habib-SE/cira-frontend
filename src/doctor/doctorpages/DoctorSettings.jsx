    ...
    const renderAvailabilitySettings = () => (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600 mb-6">Set your working hours for each day of the week</p>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-xl">
                <h4 className="font-medium text-blue-900 mb-2">Quick Settings</h4>
    ...
    const renderConsultationModes = () => (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600 mb-6">Choose which consultation modes you want to offer</p>
            </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h4 className="font-medium text-gray-900">Teleconsultation</h4>
                            <p className="text-sm text-gray-600">Video consultations from anywhere</p>
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h4 className="font-medium text-gray-900">Clinic Visits</h4>
                            <p className="text-sm text-gray-600">In-person consultations at your clinic</p>
                        </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h4 className="font-medium text-gray-900">Hybrid Mode</h4>
                            <p className="text-sm text-gray-600">Both teleconsultation and clinic visits</p>
                        </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-start space-x-3 px-3 py-3 rounded-xl transition-all duration-200 text-left ${
                                        activeTab === tab.id
