                        ...
                        <Card className="p-6">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">${earningsData.totalEarned.toLocaleString()}</p>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">${earningsData.commissionDeducted.toLocaleString()}</p>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">${earningsData.currentBalance.toLocaleString()}</p>
                                </div>
                            </div>
                        </Card>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-xl font-bold text-gray-900">${earningsData.thisMonth.toLocaleString()}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-sm text-gray-600">Last Month</p>
                                        <p className="text-xl font-bold text-gray-900">${earningsData.lastMonth.toLocaleString()}</p>
                                    </div>
                                </div>
                                <div className="w-full bg-gray-200 rounded-full h-2">
                                    <div 
                                        className="bg-pink-500 h-2 rounded-full" 
                                        style={{ width: `${(earningsData.thisMonth / earningsData.lastMonth) * 100}%` }}
                                    ></div>
                                </div>
                    ...
                    <Card className="p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                                ...
                                <button className="mt-2 px-4 py-2 bg-pink-500 text-white rounded-xl hover:bg-pink-600 transition-colors">
                                    Request Payout
                                </button>
                            </div>
                        </div>
