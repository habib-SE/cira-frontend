            ...
            <div className="relative min-h-[600px]">
                ...
                <Card className="p-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="text-xs text-gray-600 truncate">Platform Commission</p>
                            <p className="text-lg font-bold text-gray-900">${totalCommission.toFixed(2)}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="text-xs text-gray-600 truncate">Total Payouts</p>
                            <p className="text-lg font-bold text-gray-900">${totalPayouts.toFixed(2)}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="text-xs text-gray-600 truncate">Pending Payouts</p>
                            <p className="text-lg font-bold text-gray-900">${pendingPayouts.toFixed(2)}</p>
                        </div>
                    </div>
                </Card>
            </div>
