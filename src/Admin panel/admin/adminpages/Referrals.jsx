        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600">Track referral bookings and commissions by provider</p>
                </div>
                <button
                ...
                <Card className="p-4">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-bold text-gray-900">{overallConversionRate}%</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-4">
            ...
            {/* Referral Providers */}
            <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Referral Providers</h3>
                <div className="space-y-4">
